...
| Architecture styles and fit/avoid guidance | Ten Markdown/frontmatter packs contain 211 sourced entries spanning foundations, domains, decision guides, styles, patterns, technologies, references, migrations, anti-patterns, and case studies. The 128 YAML entries remain read-only compatibility data. |
